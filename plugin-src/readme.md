...
The latest version of this plugin is **5.5.8** and requires at least **WordPress 5.9** and it was tested up to **WordPress 6.9.4**.
...
7. Follow flow for UCV (Bynder portal). Select assets to use within WordPress block.
